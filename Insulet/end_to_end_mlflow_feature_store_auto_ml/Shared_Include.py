...
bronze_tbl_path = f'{get_default_path()}/bronze/raw'
silver_tbl_path = f'{get_default_path()}/silver/raw'
automl_bronze_tbl_path = f'{get_default_path()}/bronze/automl'
automl_silver_tbl_path = f'{get_default_path()}/silver/automl'
telco_preds_path = f'{get_default_path()}/preds/'

bronze_tbl_name = 'bronze_customers'
silver_tbl_name = 'silver_customers'
automl_bronze_tbl_name = 'bronze_customers_automl'
automl_silver_tbl_name = 'silver_customers_automl'
telco_preds_tbl_name = 'telco_preds'
churn_model_name = f'{current_user_name_prefix}_churn_demo'
churn_model_name_manual = f'{current_user_name_prefix}_churn_demo_manual'
key_id = 'customerID'
